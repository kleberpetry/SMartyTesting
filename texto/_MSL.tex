...
\begin{figure} [! ht]
	\centering
	\includegraphics[scale=0.50]{search_process.pdf}
...
A \ref{fig:selection_process} mostra o processo de seleção do SMS.

\begin{figure} [!ht]
	\centering
	\includegraphics[scale=0.50]{selection_process.pdf}
...
\begin{tiny}
	\begin{landscape}
		\begin{table}[!ht]
			\centering
			\footnotesize
			\caption{Estudo do Snowballing}
			\label{table:snow}	
			\begin{tabular}{c|l|c|l|c}
				\hline \hline
				
				\textbf{ID} & \multicolumn{1}{c|}{\textbf{Fonte do estudo}}  & \textbf{ID} & \multicolumn{1}{c|}{\textbf{Estudo do Snowballing}} & \textbf{Estatus} \\\hline \hline
				
				S24         & \begin{tabular}[c]{@{}l@{}l@{}}A Model Based Testing Approach\\for Model-Driven Development\\and Software Product Lines \cite{Lamancha_et_al2010}\end{tabular}                           																			& S36         & \begin{tabular}[c]{@{}l@{}}Automated model-based testing using the \\UML testing profile and QVT \cite{Lamancha_et_al2009}\end{tabular}                                   																																	& Aceito \\\hline
				
				S8          & \begin{tabular}[c]{@{}l@{}l@{}}Deriving Usage Model Variants\\for Model-based Testing:\\An Industrial Case Study \cite{samih2014deriving}\end{tabular}                                  															& S37         & \begin{tabular}[c]{@{}l@{}}Relating Variability Modeling and Model-Based \\Testing for Software Product Lines Testing \cite{samih2012relating}\end{tabular}              																																	& Aceito \\\hline
				
				S10         & \begin{tabular}[c]{@{}l@{}}Model-Based Test Design of Product Lines:\\Raising Test Design to the Product Line Level \cite{lackner2014model}\end{tabular}
				& S38         																								& \begin{tabular}[c]{@{}l@{}}An Evaluation of Model-Based Testing\\ in Embedded Applications \cite{weissleder2014evaluation}\end{tabular}                                         						& Aceito \\\hline
				
				S10         & \begin{tabular}[c]{@{}l@{}l@{}}Model-Based Test Design of Product Lines:\\Raising Test Design to the Product Line Level \cite{lackner2014model}\end{tabular}                          																			& S39        	 & \begin{tabular}[c]{@{}l@{}}Assessing Software Product Line Testing\\Via Model-Based Mutation An Application\\to Similarity Testing \cite{henard2013assessing}\end{tabular} 																															& Aceito \\\hline
				
				S5          & MPLM-MaTeLo Product Line Manager \cite{SamihBogusch2014}  					& S40        & \begin{tabular}[c]{@{}l@{}}Automated and Scalable T-wise Test Case \\Generation Strategies for Software Product Lines \cite{perrouin2010automated}\end{tabular}              																																	& Aceito \\\hline
				
				S20         & \begin{tabular}[c]{@{}l@{}}PLETS - a Product Line\\of Model-Based Testing Tools\end{tabular}                                                              		& S41        & \begin{tabular}[c]{@{}l@{}}Model based testing of system requirements\\using UML use case models \cite{hasling2008model}\end{tabular}                                  																																	& Aceito \\\hline
				
				S9          & \begin{tabular}[c]{@{}l@{}}Model-based Software Product Line Testing\\by Coupling Feature Models with\\Hierarchical Markov Chain Usage Models \cite{gebizli2016model}\end{tabular} 																												& S42        & \begin{tabular}[c]{@{}l@{}}Successive refinement of models for model-based\\testing to increase system test effectiveness \cite{gebizli2016successive}\end{tabular}         																																		& Aceito \\\hline
				
				S20         & \begin{tabular}[c]{@{}l@{}}PLETS - a Product Line\\of Model-Based Testing Tools \cite{}\end{tabular}                                                              		& S43         & \begin{tabular}[c]{@{}l@{}}A Software Product Line for Model-Based\\Testing Tools \cite{Rodrigues_et_al2012}\end{tabular}                                                                                            																	& Aceito \\\hline
				
				S21         & \begin{tabular}[c]{@{}l@{}}Top-Down and Bottom-Up Approach \\for Model-Based Testing of Product Lines \cite{weissleder2013top}\end{tabular}                                         													& S44        & \begin{tabular}[c]{@{}l@{}}Reusing State Machines for Automatic Test \\Generation in Product Lines \cite{weissleder2008reusing}\end{tabular}                  																																															& Aceito \\\hline
				
				S5          & MPLM-MaTeLo Product Line Manager \cite{SamihBogusch2014} 								& --         & \begin{tabular}[c]{@{}l@{}}An approach to derive usage models\\variants for model-based \cite{Samih_et_al2014}\end{tabular}                 
				& \begin{tabular}[c]{@{}c@{}}Duplicate\end{tabular} \\\hline
...
A \ref{table:listaextra} apresenta o conjunto final de estudos selecionados para este SMS, composto por 44 estudos (Lista Final), dos quais:os primeiros 35 são de pesquisas eletrônicas e manuais e os restantes nove são do \textit{Snowballing}.
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.50]{extraction_process.pdf}
...
\begin{figure} [!ht]
	\centering
	\includegraphics[scale=0.50]{analysis_process.pdf}
...
%Outros estudos visualizam algo semelhante, mas não funcionam de maneira modular. Eles buscam testes no nível do sistema, pois alguns deles afirmam que é muito caro lidar com uma grande quantidade de sequências de teste na engenharia de domínio do LPS. Portanto, eles só se concentram na estrutura do sistema \cite{devroey2012vision,devroey2014abstract,lochau2012parameterized,devroey2015vibes,beohar2014spinal,lackner2014model,weissleder2014avaliação,henard2013assessing,perrouin2010automated,hasling2008model,rodrigues2013plets}.
...
Nãos estudos selecionados, verificamos o uso de ferramentas \textit{fully-automated} em atividades de teste. Segundo estudos selecionados, a maioria deles utiliza algum tipo de automação para realizar tais atividades. As ferramentas usadas são amplamente implementadas pelos autores dos estudos \cite{oster2011moso, steffens2012industrial, devroey2015vibes, perrouin2010automated}, mas esses autores também fornecem comparações entre ferramentas de abordagens semelhantes \cite{oster2011moso, steffens2012industrial, devroey2015vibes, perrouin2010automated, rodrigues2013plets}.

Outro conjunto de estudos selecionados usa ferramentas \textit{semi-automated}, nas quais apenas um trecho do processo de teste é automatizado, com ou sem atividades manuais. O Olimpiew \cite{olimpiew2008model} cria casos de uso para permitir especificações de casos de teste reutilizáveis pelo arquiteto de software. De acordo com Weissleder e Lackner \cite{WeisslederLackner2013}, os modelos são usados em conjunto para modelar recursos e comportamento para a geração de diagramas de máquinas de estado e comportamento por engenheiros de software usando abordagens semi-automatizadas.
...
\begin{figure}[!ht]	
	\centering
	\includegraphics[scale=0.50]{bubble_approachXautomation.pdf}
	\caption{Automação TBM para LPS de abordagens de teste}
...
\begin{figure}[!ht]
	\centering	
	\includegraphics[scale=0.50]{bubble_Teste_level_automation.pdf}
...
\begin{figure}[!ht]	
	\centering
	\includegraphics[scale=0.40]{artefatoXlevelsXmodels.pdf}
...
\begin{table}[!ht]
	...
	\begin{tabular}{|l|l|c|}
		\hline
		\textbf{Trate a variabilidade?} & \textbf{ID do Estudo} & \textbf{Estudos} \\\hline \hline
...
Nenhum dos 44 estudos selecionados deste SMS apresenta ou menciona qualquer tipo de teste de requisitos de LPS não funcional. Embora o LPS e os produtos testados estejam geralmente em tempo de design, nada impede a criação dos requisitos não funcionais do plano de teste \cite{Lee_et_al2012}.

Feng et al. \cite{Feng_et_al2007} e Reis et al. \cite{Reis_et_al2007}, por exemplo, propõe a criação de casos de teste para a variabilidade considerando requisitos não-funcionais. 
Kakarontzas et al. \cite{Kakarontzas_et_al2008} propõe casos de teste hierárquicos para requisitos não funcionais específicos.
...
\begin{tiny}
	\begin{landscape}	
		\begin{figure}[!ht]
			\centering
			\includegraphics[scale=0.50]{guiaestudo.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.50]{etapa1.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.50]{etapa2.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.50]{etapa3.pdf}
